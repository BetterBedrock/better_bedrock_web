...
export const DOWNLOAD_LIST = [
    ...
    {
        title: "SIDE PROJECTS",
        description: "Download our side texture packs that extend your gameplay in many more ways.",
        items: [
            {
    ...
    },
    {
        ...
        items: [
            {
                title: "Better Fogs",
                description: "Better Fogs extension pack changes all fogs to make them unlimited and better for visibility",
            ...
            {
                title: "Clean Glass",
                description: "Glass extension pack changes glass textures to make them look connected and less distracting",
            ...
            {
                title: "Clean Water",
                description: "Clean Water extension pack changes water textures to make them more clean and visible",
            ...
            {
                title: "Dark UI",
                description: "UI extension pack changes most BB textures to darker ones",
            ...
            {
                title: "Dark Mode",
                description: "The Dark Mode is darker alternative to the vanilla textures",
            ...
            {
                title: "Full Grass",
                description: "Grass extension pack changes grass textures to make them look connected",
            ...
            {
                title: "Low Fire",
                description: "Fire extension pack adds lower fire texture on HUD to improve visibility",
            ...
            },
            {
                ...
                description: "Particle Limiter extension pack adds ability to limit particles by 3 options: Disabled, Minimal, All",
            ...
            {
                title: "Waypoints",
                description: "Waypoints extension pack adds ability to create vertical beams around world to improve positioning",
