import { AnalyticsDto, VoucherDto, AnalyticsNames } from "@/shared/api/openapi";
import { simplifyAnalytics } from "@/lib/analytics";
import { StatisticsCard } from "@/widgets/statistics-list";
import { calculateEstimatedProfit } from "@/pages/panel/analytics/lib/calculate-estimated-profit";
import { calculateVouchersStatistics } from "@/pages/panel/analytics/lib/calculate-vouchers-statistics";
