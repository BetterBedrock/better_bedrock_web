...
import { CreateVoucher, VoucherDto } from "@/shared/api/openapi";
import { createVoucher } from "@/entities/voucher/create-voucher";
import { fetchAllVouchers } from "@/entities/voucher/fetch-all-vouchers";
import { updateVoucher } from "@/entities/voucher/update-voucher";
