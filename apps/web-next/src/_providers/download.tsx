...
import { baseUrl, baseFrontendUrl } from "@/utils/url";
import { ProjectDto, Configuration, DownloadApi } from "@/_lib/api";
...
export const DownloadProvider = ({ children }: DownloadProviderProps) => {
  ...
  const [downloadItem, setDownloadItem] = useState<ProjectDto | undefined>(
    undefined
  );
